...
class Monitor():
    ...
    def __init__(self):
        ...
        self.server_name           = ''
        self.path_log              = ''
        self.path_race_json        = None
        self.url_webhook_log       = None
        self.url_webhook_standings = None
        self.webhook_log       = None
        self.webhook_standings = None
        ...
        # Create the webhooks
        if self.url_webhook_log:       self.webhook_log       = discord.Webhook.from_url(self.url_webhook_log,       adapter=discord.RequestsWebhookAdapter())
        if self.url_webhook_standings: self.webhook_standings = discord.Webhook.from_url(self.url_webhook_standings, adapter=discord.RequestsWebhookAdapter())
    ...
    def driver_disconnects(self, name):
        """
        ...
        if name in state['online']:
            ...
            if name in self.state['online']: state['online'].pop(name)
            self.save_state()
